          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                ...
                <form class="forms-sample" style="margin-left: 20px; margin-right: 20px;" action="<?php echo base_url('index.php/Admin_minuman/update'); ?>" method="POST">
                <input type="hidden" name="id" value="<?php echo $query->daging_id; ?>">
                <label>Judul Resep</label>
                <input type="text" name="judul_minuman" placeholder="Judul" class="form-control" value="<?php echo $query->judul_minuman; ?>"> <br>
